...
$bild = imagecreatefromjpeg($_SERVER['DOCUMENT_ROOT'] . '/SpDesign/resources/captcha/captcha.jpg');
...
//Schrift laden
$fnt = $_SERVER['DOCUMENT_ROOT'] . '/SpDesign/resources/webfonts/fa-regular-400.ttf';
